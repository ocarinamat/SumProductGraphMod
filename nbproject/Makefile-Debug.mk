...
${OBJECTDIR}/ChowLiu.o: ChowLiu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChowLiu.o ChowLiu.cpp
...
${OBJECTDIR}/Factor.o: Factor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Factor.o Factor.cpp

${OBJECTDIR}/LearnSPGM.o: LearnSPGM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LearnSPGM.o LearnSPGM.cpp
...
${OBJECTDIR}/SPGM.o: SPGM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SPGM.o SPGM.cpp

${OBJECTDIR}/SPGM_mixture.o: SPGM_mixture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SPGM_mixture.o SPGM_mixture.cpp

${OBJECTDIR}/SPGMnodes.o: SPGMnodes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SPGMnodes.o SPGMnodes.cpp

${OBJECTDIR}/kmeans-master/kmeans.o: kmeans-master/kmeans.cpp 
	${MKDIR} -p ${OBJECTDIR}/kmeans-master
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kmeans-master/kmeans.o kmeans-master/kmeans.cpp
